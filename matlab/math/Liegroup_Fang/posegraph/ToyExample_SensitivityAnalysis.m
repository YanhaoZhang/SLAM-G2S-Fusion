...
% %
G.addEdge(1, 1, 2, rlvpose12, covinv);
G.addEdge(2, 2, 3, rlvpose23, covinv);
G.addEdge(3, 3, 4, rlvpose34, covinv);
G.addEdge(4, 4, 5, rlvpose45, covinv);
G.addEdge(5, 5, 6, rlvpose56, covinv);
G.addEdge(6, 6, 7, rlvpose67, covinv);
G.addEdge(7, 7, 8, rlvpose78, covinv);
% add global loop-closure
G.addEdge(8, 1, 8, rlvpose18, covinv);
% add local loop-closure
if(1)
G.addEdge(9, 2, 4, rlvpose24, covinv);  
G.addEdge(10, 4, 6, rlvpose46, covinv);
G.addEdge(11, 6, 8, rlvpose68, covinv);
G.addEdge(12, 2, 8, rlvpose28, covinv);    
end
% display Graph Information
G.MaxIters = 50;

% enable/disable an edge, with edge id = 9
G.setEnabled(9, 1);

G.plotTrajectory(1);
%G = G.initializeProblem()

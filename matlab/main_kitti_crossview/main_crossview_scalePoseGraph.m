function [vT_us0_usk, vS_0k, vM_uok_usk] = main_crossview_scalePoseGraph(vT_us0_usk_org, vT_us0_usk, vS_0k, fine_valid, vM_uok_usk, idx)
...
while(flag)
    ...
    [F] = calculate_Error(vT_0k, vS_0k, vo_vM_usl_usk, pred_vM_uok_usk, w);
    [J] = calculate_Jacobian(vT_0k, vS_0k, vo_vM_usl_usk, pred_vM_uok_usk, w);
...
%     [V,D,W] = eig(A);
    ...
    % update 
    [vT_0k, vS_0k] = update_state(dX, vT_0k, vS_0k);

function [vT_us0_usk, vS_0k, vM_usk_uok, Cov_circle] = main_crossview_sPGO_SLAM2oxts_CVWeight_Cov_Ab_ford(vT_us0_usk_org, L, vT_us0_usk, vS_0k, fine_valid, vM_usk_uok, vP_usk_uok, vW_usk_uok, vMask_usk_uok, idx)
...
w = [0.85, 0.9, 1.0, 0.02, 0.04, 0.000, 10, 2]; 
...
while(flag)
    ...
    if (aa_dx < 1e-3 || iter>=10 || abs(min_FX-min_FX_old)<1e-6 )
        flag = false;
    end
    min_FX_old = min_FX;

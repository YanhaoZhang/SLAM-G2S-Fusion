function [vT_us0_usk, vS_0k, vM_usk_uok, Cov_circle] = main_crossview_sPGO_SLAM2oxts_CVandVOweights_Cov_Ab(vT_us0_usk_org, L, vT_us0_usk, vS_0k, fine_valid, vM_usk_uok, vP_usk_uok, vW_usk_uok, vMask_usk_uok, idx)
...
w = [0.85, 0.9, 1.0, 0.001, 0.005, 0.000, 9, 6.0]; % good result for Ford data: '2017-10-26-V2-Log6'
...
while(flag)
    ...
    if (aa_dx < 1e-3 || iter>=10 || abs(min_FX-min_FX_old)<1e-3 )
        flag = false;
    end
    min_FX_old = min_FX;
...
for k=1:num_frame
    ...
    f_0_i0 = GetCov2d_crossview(Cov_scale{k},   t_0_k0(1),  t_0_k0(2), normalzier, num_cov_pts);
    f_k_ik = R_0k'*(f_0_i0-t_0_k0);

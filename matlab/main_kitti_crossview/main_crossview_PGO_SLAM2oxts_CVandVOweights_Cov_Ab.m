function [vT_us0_usk, vS_0k, vM_usk_uok, Cov_circle] = main_crossview_PGO_SLAM2oxts_CVandVOweights_Cov_Ab(vT_us0_usk_org, L, vT_us0_usk, vS_0k, fine_valid, vM_usk_uok, vP_usk_uok, vW_usk_uok, vMask_usk_uok, idx)
...
while(flag)
    ...
    % scale weight huber
    [F] = calculate_Error_noScale_huber(vT_0k, vo_vM_usl_usk, pred_vR_usk_uok, pred_vM_usk_uok, w);
    [J] = calculate_Jacobian_noScale_huber(vT_0k, vo_vM_usl_usk, pred_vR_usk_uok, pred_vM_usk_uok, w);
    % % 
    % % % update 
    dX = -(J'*J)\(J'*F);
